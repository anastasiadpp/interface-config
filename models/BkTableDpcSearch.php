...
/**
 * BkTableDpcSearch represents the model behind the search form about `app\models\base\BkTableDpc`.
 */
class BkTableDpcSearch extends BkTableDpc
{
    /**
     * @inheritdoc
     */
