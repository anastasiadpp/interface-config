...
/**
 * RefTableDpcSearch represents the model behind the search form about `app\models\base\RefTableDpc`.
 */
class RefTableDpcSearch extends RefTableDpc
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'ID_REF_TABLE' => $this->ID_REF_TABLE,
        ]);
