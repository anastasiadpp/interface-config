...
/**
 * BkTableScpSearch represents the model behind the search form about `app\models\base\BkTableScp`.
 */
class BkTableScpSearch extends BkTableScp
{
    /**
     * @inheritdoc
     */
